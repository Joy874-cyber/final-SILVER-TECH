      ...
      <div className={`transition-all duration-300 ${sidebarCollapsed ? 'md:ml-20' : 'md:ml-60'} pt-20`}>
        <div className="p-6 max-w-7xl">
          <motion.div
            ...
            className="mb-8"
          >
            <h1 className="text-3xl font-bold text-cyan-300 mb-2">Evidence Library</h1>
            <p className="text-gray-400">Manage and organize video evidence</p>
          </motion.div>
          ...
          >
            <p className="text-gray-300">Evidence library content coming soon...</p>
          </motion.div>
        </div>
      </div>
    </main>
